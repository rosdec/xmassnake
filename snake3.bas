...
340 PRINT "{HOME} punti: ";SC
350 IF PEEK(X)=32THENTT$="{white}sei caduto!":GOSUB480:POKE 198,0:WAIT 198,1:END
360 IF PEEK(X)=42THENTT$="{red}buon natale!":GOSUB480:POKE 198,0:WAIT 198,1:GOTO200
370 GOTO 240

400 REM INIT XMAS TREE
410 I=0
420 PRINT TAB(20)"{YELLOW}*":A$="{GREEN}{V}"
430 PRINT TAB(20-I)A$ : I = I + 1
440 A$ = "{LIGHT GREEN}{N}" + A$ + "{GREEN}{M}"
